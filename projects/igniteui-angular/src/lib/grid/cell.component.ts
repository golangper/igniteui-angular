...
export class IgxGridCellComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        ...
        public transactions: IgxComplexTransaction,
    ...
    public update(val: any) {
        if (this.grid.rowEditable) {
            this.transactions.add(this.cellID, TransactionType.UPDATE, val, this.row.rowID);
        } else {
    ...
    public onKeydownEnterEditMode() {
        if (this.column.editable) {
            if (this.inEditMode) {
                if (this.grid.rowEditable) {
                    this.transactions.add(this.cellID, TransactionType.UPDATE, this.editValue, this.row.rowID);
                } else {
                    this.gridAPI.submit_value(this.gridID);
                }
            } else {
